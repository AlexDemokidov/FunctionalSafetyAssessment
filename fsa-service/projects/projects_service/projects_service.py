...
class ProjectsService:
    ...
    def place_project(self, items, user_id, name, sil, analysis, parameter1DirectlyProportional, parameter1Min, parameter1Max, parameter2DirectlyProportional, parameter2Min, parameter2Max, parameter3DirectlyProportional, parameter3Min, parameter3Max):
        return self.projects_repository.add(items, user_id, name, sil, analysis, parameter1DirectlyProportional, parameter1Min, parameter1Max, parameter2DirectlyProportional, parameter2Min, parameter2Max, parameter3DirectlyProportional, parameter3Min, parameter3Max)
