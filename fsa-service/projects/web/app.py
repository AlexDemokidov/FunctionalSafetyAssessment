...
from projects.web.api.auth import decode_and_validate_token

app = FastAPI(debug=True, docs_url="/docs/projects")
...
class AuthorizeRequestMiddleware(BaseHTTPMiddleware):
    async def dispatch(
        ...
        if request.url.path in ["/docs/projects", "/openapi/projects.json"]:
            return await call_next(request)
